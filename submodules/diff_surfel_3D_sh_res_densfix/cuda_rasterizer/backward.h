...
namespace BACKWARD
{
	...
	// `--densfix`: when 1, the AbsGS densification proxy excludes the hash-query-
	// point term (transMat/mean3D optimizer gradient unchanged). 0 = default.
	void setExcludeHashFromDensify(int v);
