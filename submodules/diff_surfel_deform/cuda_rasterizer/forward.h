...
namespace FORWARD
{
	...
	// `--deform`: per-Gauss canonical-xyz pointer for canonical-space hash queries
	// (null disables; geometry/SV always use the deformed means passed normally).
	void setCanonicalXyz(const float* ptr);
