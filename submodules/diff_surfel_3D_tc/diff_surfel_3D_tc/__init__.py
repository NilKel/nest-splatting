...
def set_mlp_weights(W1, W2, W3, is_sh_mode=False):
    ...
    Layer 1 uses input padding (input[40]=1.0) for implicit bias via W1[:, 40].
    Layers 2 and 3 have no bias.

    Args:
        W1: [32, 41] Layer 1 weights (input → hidden1), last column acts as bias
...
def get_mlp_grads():
    ...
    Returns:
        ...
        - grad_W1: [32, 41] Layer 1 weight gradients (last column = implicit bias grad)
