...
#define CONVERGE_OFFSET 18  // Per-pixel accumulated convergence loss (Unbiased Depth, Peng et al.)
// #define MEDIAN_WEIGHT_OFFSET 7

// Unbiased Depth constants (Peng et al.)
// Reference impl: XiaoXinyyx/diff_surfel_rasterization (commit b6c7b7a)
#define UNBIASED_OPACITY_THRESH 0.6f   // Surface lock-in when cumulative opacity crosses this
#define UNBIASED_OPACITY_EPS    0.1f   // Per-splat epsilon multiplied by G in cum_opacity accum
#define CONVERGE_THRESHOLD      1.0f   // Skip depth pair if |d_i - d_{i-1}| > this
#define CONVERGE_T_GATE         0.09f  // Only accumulate convergence loss while T > this
#define CONVERGE_BACKWARD_SCALE 1.25f  // Asymmetric grad scale when current depth > neighbor
