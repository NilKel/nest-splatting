...
CudaRasterizer::ImageState CudaRasterizer::ImageState::fromChunk(char*& chunk, size_t N)
{
	...
	// n_contrib layout (3 entries per pixel for unbiased build):
	//   [0]      = last_contributor
	//   [N*W*H]  = median_contributor (under unbiased: last cum-opacity-locked contributor)
	//   [2*N*W*H]= last_converge (last contributor counted into convergence loss)
	obtain(chunk, img.n_contrib, N * 3, 128);
