...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("set_frontmost_first", &SetFrontmostFirstCUDA,
        "GES frontmost-first promotion (harden): 1 = promote each pixel's "
  ...
  m.def("set_tile_depth_sort", &SetTileDepthSortCUDA);
