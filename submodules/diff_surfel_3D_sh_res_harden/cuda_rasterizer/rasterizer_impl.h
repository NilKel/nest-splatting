...
namespace CudaRasterizer
{
	...
	struct ImageState
	{
		...
		uint32_t* n_contrib;
		float* accum_alpha;
		// GES frontmost-first promotion (d_frontmost_first): per-pixel 1-based
		// contributor index of the promoted frontmost surfel (0 = none) + the
		// full non-frontmost composite color [3N] — written by the forward,
