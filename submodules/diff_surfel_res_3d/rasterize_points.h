...
// `--method res_3d_double`: per-Gauss bias gate. Default 1 = tex carriers
// force sh_color = 0 → feat = residual (plain `res_3d` behavior).
// 0 = keep SH evaluated → feat = ReLU(SV+0.5) + residual (full capacity).
