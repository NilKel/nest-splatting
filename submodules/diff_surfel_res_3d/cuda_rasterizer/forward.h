...
namespace FORWARD
{
	...
	// `--method res_3d_double`: when 0, tex carriers KEEP sh_color = ReLU(SV+0.5)
	// → feat = SV + residual (full mixed_3d-style capacity). When 1 (default for
	// `--method res_3d`), tex carriers force sh_color = 0 → feat = residual only.
